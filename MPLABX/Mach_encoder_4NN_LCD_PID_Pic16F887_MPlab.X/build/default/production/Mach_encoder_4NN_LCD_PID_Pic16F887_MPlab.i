# 1 "Mach_encoder_4NN_LCD_PID_Pic16F887_MPlab.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Mach_encoder_4NN_LCD_PID_Pic16F887_MPlab.c" 2
...
# 22 "Mach_encoder_4NN_LCD_PID_Pic16F887_MPlab.c" 2
...
int PWM_Max_Duty()
{
  return(20000000/(freq*16));
}
PWM1_Init(long fre)
{
  PR2 = (20000000/(fre*4*16)) - 1;
  freq = fre;
}
PWM2_Init(long fre)
{
...
# 23 "Mach_encoder_4NN_LCD_PID_Pic16F887_MPlab.c" 2
